...
//var cleanTargetUrl = url.split('#')[0].split('?')[0];
        ...
        if (isCurrentUrlMatched) {
            (function () {
                ...
                let equip = ["武士之魂", "布衣", "赫尔墨斯·看守者之杖", "男用贞操带", "圣英灵秘银甲", "石鬼面", "巴啦啦小魔仙棒", "贤者头盔", "符文披风", "星芒戒指", "骑士遗盔", "恩惠护符", "十字叶章", "蔷薇骑士之刃", "狩猎用小刀", "刺杀者匕首", "琉璃玉坠", "月陨戒指", "日荒戒指", "神圣十字章", "艾尔尤因", "冒险专用绳索", "十字军护盾", "力量腕带", "药剂背袋", "物理学圣剑", "眼镜蛇图腾", "海盗弯钩", "钢铁勇士弯刀", "猎鹰图腾", "山猫图腾", "重磅手环", "新月护符", "龙血之斧", "生锈的海盗刀枪", "念念往日士官盔", "超级名贵无用宝剑", "嗜血斩首斧", "变形软泥", "净化手杖", "超级幸运无敌辉石", "守望者徽章", "破旧打火机", "女神之泪", "和谐圣杯", "天使之赐", "棱镜", "射手的火枪"];
                ...
                let forum = ["达拉然", "时间变异管理局", "美恐：启程", "男巫之歌", "最终幻想XIV", "赛博朋克2077", "龙腾世纪：审判", "荒野大镖客：救赎 II", "奥兹大陆", "五花八门", "TRPG版塊", "堕落飨宴", "质量效应三部曲", "上古卷轴V：天际", "雾都血医", "恶魔城", "生化危机：复仇", "街头霸王", "模拟人生4", "寶可夢 Pokémon", "英雄联盟", "辐射：新维加斯", "最终幻想XVI", "雄躯的昇格", "极客的晚宴"];
                ...
                let spell = ["炼金之心", "黑暗交易", "水泡术", "召唤古代战士", "祈祷术", "吞噬魂魄", "咆哮诅咒", "霍格沃茨五日游", "石肤术", "雷霆晶球", "思绪骤聚", "杀意人偶"];
                let plot = ["『日心说』", "『任天堂Switch』红蓝√", "『任天堂Switch』灰黑√", "『还乡歌』", "『私有海域』", "『钜鲸』", "『召唤好运的角笛』", "『圣洁化身』", "『矩阵谜钥Ⓖ』", "『新居手册Ⓖ』", "『居住证: Lv2-6』", "『户口本: Lv7+』", "『瓶中信』", "『 弗霖的琴』", "『伊黎丝的祝福』", "『灰域来音』", "『迷翳之中』", "『迷翳森林回忆录』", "『星河碎片』", "『列车长』"];
                let result = {
                    "游戏男从(10)": "",
                    "真人男从(8)": "",
                    "女从(4)": "",
